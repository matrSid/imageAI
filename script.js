const apiKey = "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";
const maxImages = 1; // Number of images to generate for each prompt
...
async function generateImages(input) {
    ...
    // Expecting binary data, so not parsing JSON
    ...
    img.src = imgUrl;
    img.alt = `art-1`;
    img.onclick = () => downloadImage(imgUrl, 0);
